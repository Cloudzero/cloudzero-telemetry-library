...
-- Snowflake Usage-Based Cost Allocation - Native Composite Allocation
-- Allocates warehouse costs using weighted combination of multiple usage metrics
...
-- Extract query metadata and calculate composite score from QUERY_HISTORY
